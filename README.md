...
2. Set Up AWS CLI: Install the AWS Command Line Interface (CLI) and configure it with your AWS credentials.

3. Launch an EC2 Instance: Go to the EC2 dashboard, launch an EC2 instance (virtual server), and choose an Amazon Machine Image (AMI) that supports Node.js (Ubuntu).

4. SSH into Your EC2 Instance: Once your instance is running, SSH into it using the SSH key pair you specified during instance creation.

5. Make sure you have Docker installed on your system.

6. Make sure you have jenkins installed on your system for CI/CD.

7. Knowledge about Webhooks and Email notification
